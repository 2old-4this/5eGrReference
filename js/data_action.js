data_action = [
    ...
    },
    {
        ...
        bullets: [
          ...
          "Όταν προετοιμάσετε ένα ξόρκι, το ρίχνετε κανονικά, αλλά κρατάτε την ενέργειά του, την οποία απελευθερώνετε με το reaction σας όταν εμφανιστεί η ευκαιρία. Για να προετοιμαστεί, ένα ξ
