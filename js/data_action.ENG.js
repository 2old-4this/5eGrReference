data_action = [
    {
        ...
        bullets: [
            ...
            "Ορισμένες δυνατότητες, όπως η δυνατότητα <i>Extra Attack</i> του μαχητή, σας επιτρέπουν να κάνετε περισσότερες από μία επίθεση με αυτήν την ενέργεια. Κάθε μία από αυτές τις επιθέσεις είναι ένα ξεχωριστό ROLL και μπορεί να στοχεύει διαφορετικά πλάσματα. Μπορείτε να μετακινηθείτε μεταξύ αυτών των επιθέσεων. ",
